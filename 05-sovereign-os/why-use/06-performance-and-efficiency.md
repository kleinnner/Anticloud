# 01s Sovereign â€” Performance and Efficiency
...
| Hash computation (SHA3-256) | ~0.5Î¼s | Hardware accelerated |
...
- Writes are asynchronous and non-blocking â€” user experience is never impacted
...
|---|---|---|
| systemd parallel startup | ~5s | ~15s â†’ ~10s |
| Custom kernel modules | ~2s | ~10s â†’ ~8s |
| Background service deferral | ~1s | ~8s â†’ ~7s |
| Readahead optimization | ~2s | ~7s â†’ ~5s |
| **Total optimized boot** | **~10-15s** | **~25s â†’ ~10s** |
...
| Single application | ~0.5GB free | ~0.3GB free | â€” |
...
|---|---|---|---|
| 2010-2013 (Core 2/i3) | Not supported | âœ… Fully usable | 3-5 years |
| 2014-2017 (i5-6xxx) | Windows 11 blocked | âœ… Fully usable | 5-8 years |
| 2018-2020 (i7-8xxx) | Windows 11 compatible | âœ… Optimal | Continues normally |
| 2021+ (i7-12xxx) | Optimal | âœ… Optimal | Continues normally |
