...
The Law-11 module (no-black-boxes variant) documents Inte11ect's commitment to zero hidden behavior — no undisclosed features, telemetry, data collection, or background operations.
