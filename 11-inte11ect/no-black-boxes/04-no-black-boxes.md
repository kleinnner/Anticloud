...
# no-black-boxes - Document 04

> **Associated Module:** Pol-11
## Dependency Disclosure

The Pol-11 module (no-black-boxes variant) documents Inte11ect's complete dependency disclosure policy.

### What We Disclose

Inte11ect provides complete disclosure of all dependencies including direct dependencies, transitive dependencies, development dependencies, system dependencies, and build dependencies.

### How We Disclose

- **SBOM**: SPDX 2.3 format per release
- **Dependency Manifests**: Cargo.toml, package.json, requirements.txt
- **License Reports**: Complete license compliance documentation
- **Vulnerability Reports**: Public disclosure of all known vulnerabilities

### SBOM Generation

SBOMs are generated automatically for every release and include package name, version, supplier, download location, license, checksums for verification, and external references for each dependency.

### Dependency Verification

```bash
inte11ect-cli sbom list                     # List all dependencies
inte11ect-cli sbom check-vulnerabilities    # Check for known vulnerabilities
inte11ect-cli sbom verify-licenses          # Verify license compliance
inte11ect-cli sbom diff --version 2.0.3     # Compare dependencies across versions
```
...
Complete dependency disclosure ensures enterprise security teams have full visibility into Inte11ect's software supply chain, enabling thorough security and compliance assessment.
