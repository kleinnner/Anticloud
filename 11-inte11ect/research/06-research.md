...
Uniform quantization maps a floating-point range [β, α] to a discrete integer grid {0, 1, ..., 2^n - 1}:
...
| Quantization | PPL | ΔPPL | Model Size | Compression |
|---|---|---|---|---|
...
| Benchmark | FP16 | INT8 | Q4_K_M | Δ (Q4_K_M) |
|---|---|---|---|---|
