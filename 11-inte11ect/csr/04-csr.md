...
|--------|----------|----------|---------|
| NVML direct | Â±2% | NVIDIA GPUs | 1ms |
| AMD-SMI direct | Â±3% | AMD GPUs | 1ms |
| Intel RAPL | Â±5% | Intel CPUs | 2ms |
| Apple power | Â±4% | Apple Silicon | 2ms |
| Software estimate | Â±15% | All hardware | 0ms |
