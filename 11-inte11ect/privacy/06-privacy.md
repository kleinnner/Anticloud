...
|-------------|-----------|-----------------|---------------------|
| European Union | GDPR | Data minimization, purpose limitation | ✅ Inherent |
| United Kingdom | UK GDPR | Same as GDPR | ✅ Inherent |
| California | CCPA/CPRA | Right to know, delete, opt-out | ✅ Inherent |
| Canada | PIPEDA | Consent, purpose specification | ✅ Inherent |
| Brazil | LGPD | Similar to GDPR | ✅ Inherent |
| India | DPDPA | Data localization, consent | ✅ Inherent |
| Japan | APPI | Purpose limitation, security | ✅ Inherent |
| South Korea | PIPA | Consent, data protection | ✅ Inherent |
| Australia | Privacy Act | APP principles | ✅ Inherent |
| China | PIPL | Data localization, security assessment | ✅ Inherent |
