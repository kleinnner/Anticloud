...
|---------------|------------------------|------------|
| Lawfulness, fairness, transparency | Open source code, transparent data practices | ✅ |
| Purpose limitation | Data only used for inference (locally) | ✅ |
| Data minimization | Zero data collected by default | ✅ |
| Accuracy | User controls their data | ✅ |
| Storage limitation | All data stored locally, user-controlled | ✅ |
| Integrity and confidentiality | Local processing, signed .aioss files | ✅ |
| Accountability | Open source, auditable codebase | ✅ |
