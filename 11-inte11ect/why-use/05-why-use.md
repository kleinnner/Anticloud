...
|-------|-----------|-------|-------|-------------|
| Inference | Model execution | ✅ Always | ❌ Never | INT4 quantized, GPU/CPU/NPU |
| Storage | User data | ✅ Local files | ❌ Never | JSON, SQLite, .aioss |
| Configuration | Settings | ✅ Local files | ❌ Never | YAML configuration |
| Updates | Software updates | ✅ Pull-based | ✅ Registry check | Optional, user-initiated |
| Models | Model downloads | ✅ Peer-to-peer | ✅ Registry | Once per model |
| Carbon | Grid intensity | ✅ Fallback | ✅ Real-time | Optional, opt-in |
