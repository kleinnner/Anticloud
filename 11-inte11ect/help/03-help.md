...
> **Associated Module:** Geo-11
## Model Loading Errors

The Geo-11 module documents model loading errors and their solutions.

### Common Model Errors

| Error | Cause | Solution |
|-------|-------|----------|
| model_not_found | Model not downloaded | `inte11ect-cli model download` |
| signature_invalid | Corrupted model | `inte11ect-cli model verify --reinstall` |
| insufficient_vram | Not enough GPU memory | Use smaller model or INT4 quantization |
| incompatible_hardware | GPU not supported | Use CPU fallback: `--cpu-fallback` |
| model_busy | Model in use by another process | Wait or restart application |
| version_mismatch | Model needs newer Inte11ect | Update Inte11ect: `inte11ect-cli update` |

### Diagnostic Commands

```bash
inte11ect-cli model list              # List installed models
inte11ect-cli model verify --all      # Verify all models
inte11ect-cli model status            # Current model status
inte11ect-cli system vram             # Check available VRAM
...
inte11ect-cli system requirements     # Check system requirements
```
