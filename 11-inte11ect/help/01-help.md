...
> **Associated Module:** Phil-11
## Common Bugs

The Phil-11 module documents common bugs encountered by Inte11ect users and provides detailed solutions.

### Bug 1: Model Fails to Load

**Symptoms**: Model loading hangs or fails with "model_load_failed" error.
...
**Solutions**:
1. Check disk space: `inte11ect-cli system disk-space`
2. Re-download model: `inte11ect-cli model reinstall qwen2-vl-2b-instruct`
3. Verify system requirements
4. Check logs: `inte11ect-cli logs show --module model-loader`

### Bug 2: Slow Inference
...
**Solutions**:
1. Check GPU detection: `inte11ect-cli system detect-gpu`
2. Close resource-intensive applications
3. Check temperature: `inte11ect-cli system gpu-temp`
4. Disable power saving for Inte11ect

### Bug 3: Application Crashes on Launch

**Symptoms**: Tauri window crashes immediately after opening.
...
**Solutions**:
1. Reset configuration: `inte11ect-cli config reset`
2. Update GPU drivers
3. Check dependencies: `inte11ect-cli doctor`
4. Reinstall application

### Bug 4: Updates Fail to Install

**Symptoms**: Update download fails or installation fails.
...
**Solutions**:
1. Check network: Test connectivity to packages.inte11ect.ai
2. Free disk space: Need at least 2GB free
3. Add Inte11ect to antivirus exclusions
4. Run as administrator
5. Manual update: Download from website

### Bug 5: Energy Tracking Shows Zero

**Symptoms**: Energy dashboard shows 0 Wh for all queries.

**Causes**:
- Hardware monitoring not supported
- Driver issues
- Power monitoring disabled

**Solutions**:
1. Check GPU compatibility: `inte11ect-cli system energy-capable`
2. Update GPU drivers
3. Enable energy tracking in settings
4. Fall back to estimation mode

### Bug 6: High Memory Usage

**Symptoms**: Inte11ect using > 8GB RAM.
...
**Solutions**:
1. Unload unused models: `inte11ect-cli model unload --all`
2. Reduce max context window in settings
3. Restart application
4. Report memory leak: `inte11ect-cli logs export`

### Bug 7: GPU Not Detected

**Symptoms**: Application uses CPU despite having a GPU.
...
2. Check GPU support at inte11ect.ai/hardware
3. Close GPU-intensive applications
4. Check VM GPU passthrough configuration
...
To report a new bug: `inte11ect-cli bug-report --describe "Bug description"` or open a GitHub issue at github.com/inte11ect/platform/issues
