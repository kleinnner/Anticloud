...
> **Associated Module:** His-11
## Installation Issues

The His-11 module documents common installation issues and solutions for all supported platforms.

### Windows Installation Issues

**Issue**: Windows Defender blocks installation.
**Solution**: Add installer to Windows Defender exclusions.

**Issue**: Installer fails with "access denied".
**Solution**: Run installer as Administrator.

**Issue**: Missing VC++ redistributable.
**Solution**: Install Visual C++ Redistributable for Visual Studio 2015-2022.

### macOS Installation Issues

**Issue**: "App is damaged and cannot be opened."
**Solution**: Remove quarantine attribute: `xattr -d com.apple.quarantine Inte11ect.app`

**Issue**: "App cannot be opened because the developer cannot be verified."
**Solution**: Open System Preferences > Security & Privacy > Open Anyway

### Linux Installation Issues

**Issue**: Missing system dependencies.
**Solution**: Install required packages: `sudo apt install libwebkit2gtk-4.1-dev libgtk-3-dev`

### Common Issues

- **Antivirus interference**: Add Inte11ect to exclusions
- **Insufficient permissions**: Run installer as admin/sudo
...
- **Disk space**: Ensure 2GB+ free space available
- **Network**: Firewall may block initial download
