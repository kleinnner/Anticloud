...
The Med-11 module documents the support channels available to Inte11ect users.

### Support Channels

| Channel | Availability | Response Time | Best For |
|---------|-------------|---------------|----------|
| Documentation | 24/7 | Instant | Self-service troubleshooting |
| GitHub Issues | 24/7 | 24-48 hours | Bug reports, feature requests |
| Discord Community | 24/7 | Variable | Community support |
| Email Support | Business hours | 4-24 hours | Account and billing |
| Enterprise Support | 24/7 | 1-4 hours SLA | Enterprise customers |

### Self-Service Resources

- **Documentation**: inte11ect.ai/docs
- **FAQ**: inte11ect.ai/faq
- **GitHub Wiki**: github.com/inte11ect/platform/wiki
- **Troubleshooting Guide**: inte11ect.ai/troubleshoot
- **Release Notes**: inte11ect.ai/releases

### Enterprise Support

Enterprise customers have access to:
- Dedicated support engineer
- 4-hour response SLA (1-hour for critical)
- Priority bug fixes
...
3. Run diagnostic: `inte11ect-cli doctor`
4. Export logs: `inte11ect-cli logs export`

### Contact

- **Security Issues**: security@inte11ect.ai
- **Enterprise Support**: enterprise-support@inte11ect.ai
- **General Inquiries**: hello@inte11ect.ai
...
- **GitHub**: github.com/inte11ect/platform
