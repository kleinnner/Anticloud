...
> **Associated Module:** Tech-11
## Connection Issues

The Tech-11 module documents network and connection issues and their solutions.

### Update Connection Issues

**Issue**: Cannot connect to update server.
**Solutions**:
1. Check firewall: Allow outbound TCP 443 to packages.inte11ect.ai
2. Proxy configuration: Set HTTPS_PROXY environment variable
3. Air-gapped deployment: Use offline bundle installation

### Model Download Issues

**Issue**: Model downloads fail or are slow.
**Solutions**:
1. Check network speed: `inte11ect-cli network speed-test`
2. Resume download: `inte11ect-cli model download --resume`
3. Use enterprise mirror: Configure in settings
