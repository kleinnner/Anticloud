---
title: "CODE OF CONDUCT — API-SOS"
sidebar_position: 99
description: "*Version:** 1.0 (May 2026)"
tags: [governance]
---

# CODE OF CONDUCT — API-SOS

**Version:** 1.0 (May 2026)
**Applies to:** All API-SOS project spaces (GitHub, Discord, social media, events)

---

## 1. OUR PLEDGE

We as members, contributors, and leaders pledge to make participation in the API-SOS community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
- Focus on what is best for the community and the mission: sovereign AI for everyone
...
- Deliberate misrepresentation of API-SOS's capabilities, security, or architecture
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at conduct@api-sos.ai. All complaints will be reviewed and investigated promptly and fairly.
